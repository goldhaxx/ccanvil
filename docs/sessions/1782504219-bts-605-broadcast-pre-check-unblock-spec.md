# Feature: Unblock [ccanvil-sync.sh](<http://ccanvil-sync.sh>) broadcast across downstream nodes

> Feature: bts-605-broadcast-pre-check-unblock
> Work: linear:BTS-605
> Created: 1782439224
> Subject: Unblock [ccanvil-sync.sh](<http://ccanvil-sync.sh>) broadcast across downstream nodes
> Status: In Progress
