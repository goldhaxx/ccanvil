...
- [ ] **AC-7:** A new bats test file `hub/tests/module-manifest-seed-allowlist.bats` covers AC-1 / AC-2 / AC-3 / AC-4 / AC-6 against fixture node trees in `$BATS_TEST_TMPDIR`.
